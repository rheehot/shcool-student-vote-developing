.class public Lorg/shaded/apache/http/client/utils/URIUtils;
...
.method public static resolve(Ljava/net/URI;Ljava/lang/String;)Ljava/net/URI;
    ...
    invoke-static {p0, v0}, Lorg/shaded/apache/http/client/utils/URIUtils;->resolve(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
...
.method public static resolve(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    .line 191
    invoke-static {p0, p1}, Lorg/shaded/apache/http/client/utils/URIUtils;->resolveReferenceStartingWithQueryString(Ljava/net/URI;Ljava/net/URI;)Ljava/net/URI;
    ...
    :cond_4
    invoke-static {v1}, Lorg/shaded/apache/http/client/utils/URIUtils;->removeDotSegments(Ljava/net/URI;)Ljava/net/URI;
...
.method public static rewriteURI(Ljava/net/URI;Lorg/shaded/apache/http/HttpHost;)Ljava/net/URI;
    .locals 1
    .param p0, "uri"    # Ljava/net/URI;
    ...
    invoke-static {p0, p1, v0}, Lorg/shaded/apache/http/client/utils/URIUtils;->rewriteURI(Ljava/net/URI;Lorg/shaded/apache/http/HttpHost;Z)Ljava/net/URI;
...
.method public static rewriteURI(Ljava/net/URI;Lorg/shaded/apache/http/HttpHost;Z)Ljava/net/URI;
    .locals 7
    .param p0, "uri"    # Ljava/net/URI;
    .param p1, "target"    # Lorg/shaded/apache/http/HttpHost;
    ...
    invoke-virtual {p1}, Lorg/shaded/apache/http/HttpHost;->getHostName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p1}, Lorg/shaded/apache/http/HttpHost;->getPort()I
    ...
    :goto_0
    invoke-static/range {v0 .. v5}, Lorg/shaded/apache/http/client/utils/URIUtils;->createURI(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/net/URI;
