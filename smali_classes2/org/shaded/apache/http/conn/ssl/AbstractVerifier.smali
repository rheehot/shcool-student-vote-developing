.class public abstract Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;
.super Ljava/lang/Object;
.source "AbstractVerifier.java"

# interfaces
.implements Lorg/shaded/apache/http/conn/ssl/X509HostnameVerifier;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->BAD_COUNTRY_2LDS:[Ljava/lang/String;

    .line 78
    sget-object v0, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->BAD_COUNTRY_2LDS:[Ljava/lang/String;
...
.method public static acceptableCountryWildcard(Ljava/lang/String;)Z
    ...
    sget-object v4, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->BAD_COUNTRY_2LDS:[Ljava/lang/String;
...
.method public static getDNSSubjectAlts(Ljava/security/cert/X509Certificate;)[Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->getSubjectAlts(Ljava/security/cert/X509Certificate;Ljava/lang/String;)[Ljava/lang/String;
...
.method private static getSubjectAlts(Ljava/security/cert/X509Certificate;Ljava/lang/String;)[Ljava/lang/String;
    ...
    .prologue
    .line 292
    invoke-static {p1}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->isIPAddress(Ljava/lang/String;)Z
    ...
    const-class v10, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;
...
.method private static isIPAddress(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lorg/shaded/apache/http/conn/util/InetAddressUtils;->isIPv4Address(Ljava/lang/String;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lorg/shaded/apache/http/conn/util/InetAddressUtils;->isIPv6Address(Ljava/lang/String;)Z
...
.method public final verify(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V
    ...
    .prologue
    .line 147
    invoke-static {p2}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->getCNs(Ljava/security/cert/X509Certificate;)[Ljava/lang/String;

    move-result-object v0

    .line 148
    .local v0, "cns":[Ljava/lang/String;
    invoke-static {p2, p1}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->getSubjectAlts(Ljava/security/cert/X509Certificate;Ljava/lang/String;)[Ljava/lang/String;

    move-result-object v1

    .line 149
    .local v1, "subjectAlts":[Ljava/lang/String;
    invoke-virtual {p0, p1, v0, v1}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->verify(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)V
...
.method public final verify(Ljava/lang/String;Ljavax/net/ssl/SSLSocket;)V
    ...
    invoke-virtual {p0, p1, v3}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->verify(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V
...
.method public final verify(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;Z)V
    ...
    invoke-static {v3}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->acceptableCountryWildcard(Ljava/lang/String;)Z

    move-result v13

    if-eqz v13, :cond_8

    invoke-static/range {p1 .. p1}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->isIPAddress(Ljava/lang/String;)Z
    ...
    .line 210
    invoke-static {v5}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->countDots(Ljava/lang/String;)I

    move-result v13

    invoke-static {v3}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->countDots(Ljava/lang/String;)I
...
.method public final verify(Ljava/lang/String;Ljavax/net/ssl/SSLSession;)Z
    ...
    invoke-virtual {p0, p1, v2}, Lorg/shaded/apache/http/conn/ssl/AbstractVerifier;->verify(Ljava/lang/String;Ljava/security/cert/X509Certificate;)V
    :try_end_0
