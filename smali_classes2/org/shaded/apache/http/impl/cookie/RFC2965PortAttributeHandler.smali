.class public Lorg/shaded/apache/http/impl/cookie/RFC2965PortAttributeHandler;
...
.method public match(Lorg/shaded/apache/http/cookie/Cookie;Lorg/shaded/apache/http/cookie/CookieOrigin;)Z
    ...
    .line 155
    :cond_1
    invoke-virtual {p2}, Lorg/shaded/apache/http/cookie/CookieOrigin;->getPort()I

    move-result v0

    .line 156
    .local v0, "port":I
    instance-of v1, p1, Lorg/shaded/apache/http/cookie/ClientCookie;

    if-eqz v1, :cond_3

    move-object v1, p1

    check-cast v1, Lorg/shaded/apache/http/cookie/ClientCookie;

    const-string v3, "port"

    invoke-interface {v1, v3}, Lorg/shaded/apache/http/cookie/ClientCookie;->containsAttribute(Ljava/lang/String;)Z
    ...
    .line 158
    invoke-interface {p1}, Lorg/shaded/apache/http/cookie/Cookie;->getPorts()[I
    ...
    invoke-static {v0, v1}, Lorg/shaded/apache/http/impl/cookie/RFC2965PortAttributeHandler;->portMatch(I[I)Z
...
.method public parse(Lorg/shaded/apache/http/cookie/SetCookie;Ljava/lang/String;)V
    ...
    .line 111
    :cond_0
    instance-of v2, p1, Lorg/shaded/apache/http/cookie/SetCookie2;
    ...
    .line 114
    invoke-static {p2}, Lorg/shaded/apache/http/impl/cookie/RFC2965PortAttributeHandler;->parsePortAttribute(Ljava/lang/String;)[I

    move-result-object v1

    .line 115
    .local v1, "ports":[I
    invoke-interface {v0, v1}, Lorg/shaded/apache/http/cookie/SetCookie2;->setPorts([I)V
...
.method public validate(Lorg/shaded/apache/http/cookie/Cookie;Lorg/shaded/apache/http/cookie/CookieOrigin;)V
    ...
    invoke-interface {v1, v2}, Lorg/shaded/apache/http/cookie/ClientCookie;->containsAttribute(Ljava/lang/String;)Z
