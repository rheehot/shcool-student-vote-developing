.class public Lorg/shaded/apache/http/impl/cookie/RFC2965VersionAttributeHandler;
...
.method public parse(Lorg/shaded/apache/http/cookie/SetCookie;Ljava/lang/String;)V
    ...
    .line 61
    new-instance v2, Lorg/shaded/apache/http/cookie/MalformedCookieException;

    const-string v3, "Missing value for version attribute"

    invoke-direct {v2, v3}, Lorg/shaded/apache/http/cookie/MalformedCookieException;-><init>(Ljava/lang/String;)V
    ...
    :cond_2
    invoke-interface {p1, v1}, Lorg/shaded/apache/http/cookie/SetCookie;->setVersion(I)V
...
.method public validate(Lorg/shaded/apache/http/cookie/Cookie;Lorg/shaded/apache/http/cookie/CookieOrigin;)V
    ...
    .line 85
    instance-of v0, p1, Lorg/shaded/apache/http/cookie/ClientCookie;

    if-eqz v0, :cond_1

    check-cast p1, Lorg/shaded/apache/http/cookie/ClientCookie;

    .end local p1    # "cookie":Lorg/shaded/apache/http/cookie/Cookie;
    const-string v0, "version"

    invoke-interface {p1, v0}, Lorg/shaded/apache/http/cookie/ClientCookie;->containsAttribute(Ljava/lang/String;)Z
