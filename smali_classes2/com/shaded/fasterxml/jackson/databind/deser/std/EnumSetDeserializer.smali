.class public Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;
...
.field protected _enumDeserializer:Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field protected final _enumType:Lcom/shaded/fasterxml/jackson/databind/JavaType;
...
.method public constructor <init>(Lcom/shaded/fasterxml/jackson/databind/JavaType;Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;)V
    ...
    .line 41
    iput-object p1, p0, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->_enumType:Lcom/shaded/fasterxml/jackson/databind/JavaType;
    ...
    iput-object v0, p0, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->_enumClass:Ljava/lang/Class;

    .line 43
    iput-object p2, p0, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->_enumDeserializer:Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;
...
.method private constructSet()Ljava/util/EnumSet;
    ...
    .prologue
    .line 125
    iget-object v0, p0, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->_enumClass:Ljava/lang/Class;
...
.method public createContextual(Lcom/shaded/fasterxml/jackson/databind/DeserializationContext;Lcom/shaded/fasterxml/jackson/databind/BeanProperty;)Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;
    ...
    .prologue
    .line 64
    iget-object v0, p0, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->_enumDeserializer:Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;

    .line 65
    if-nez v0, :cond_1

    .line 66
    iget-object v0, p0, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->_enumType:Lcom/shaded/fasterxml/jackson/databind/JavaType;
    ...
    :cond_0
    :goto_0
    invoke-virtual {p0, v0}, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->withDeserializer(Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;)Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;
...
.method public bridge synthetic deserialize(Lcom/shaded/fasterxml/jackson/core/JsonParser;Lcom/shaded/fasterxml/jackson/databind/DeserializationContext;)Ljava/lang/Object;
    ...
    .prologue
    .line 18
    invoke-virtual {p0, p1, p2}, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->deserialize(Lcom/shaded/fasterxml/jackson/core/JsonParser;Lcom/shaded/fasterxml/jackson/databind/DeserializationContext;)Ljava/util/EnumSet;
...
.method public deserialize(Lcom/shaded/fasterxml/jackson/core/JsonParser;Lcom/shaded/fasterxml/jackson/databind/DeserializationContext;)Ljava/util/EnumSet;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 90
    :cond_0
    invoke-direct {p0}, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->constructSet()Ljava/util/EnumSet;
...
.method public withDeserializer(Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;)Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer",
            "<*>;)",
            "Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;"
        }
    .end annotation
    ...
    iget-object v1, p0, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;->_enumType:Lcom/shaded/fasterxml/jackson/databind/JavaType;

    invoke-direct {v0, v1, p1}, Lcom/shaded/fasterxml/jackson/databind/deser/std/EnumSetDeserializer;-><init>(Lcom/shaded/fasterxml/jackson/databind/JavaType;Lcom/shaded/fasterxml/jackson/databind/JsonDeserializer;)V
